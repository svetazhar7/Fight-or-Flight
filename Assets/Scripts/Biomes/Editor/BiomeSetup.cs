...
public static class BiomeSetup
{
    ...
    public static void CreateBiomeAssets()
    {
        ...
        // Elevation biomes are placed by terrain height; climate biomes form the large regions.
        CreateBiome(folder, "Ocean",     new Color(0.05f, 0.15f, 0.55f), 0f,    0.2f,  0f,    0.4f,  0.6f,  1f, BiomePlacement.Elevation);
        CreateBiome(folder, "Beach",     new Color(0.93f, 0.87f, 0.55f), 0.18f, 0.28f, 0.4f,  0.8f,  0.2f,  0.6f, BiomePlacement.Elevation);
        CreateBiome(folder, "Plains",    new Color(0.55f, 0.80f, 0.35f), 0.25f, 0.55f, 0.3f,  0.7f,  0.3f,  0.7f, BiomePlacement.Climate);
        CreateBiome(folder, "Forest",    new Color(0.13f, 0.45f, 0.13f), 0.28f, 0.60f, 0.2f,  0.6f,  0.55f, 1f, BiomePlacement.Climate);
        CreateBiome(folder, "Desert",    new Color(0.85f, 0.75f, 0.40f), 0.22f, 0.50f, 0.6f,  1f,    0f,    0.3f, BiomePlacement.Climate);
        CreateBiome(folder, "Mountains", new Color(0.55f, 0.55f, 0.55f), 0.55f, 0.80f, 0f,    0.7f,  0f,    0.7f, BiomePlacement.Elevation);
        CreateBiome(folder, "Snow",      new Color(0.93f, 0.95f, 1.00f), 0.72f, 1f,    0f,    0.25f, 0f,    1f, BiomePlacement.Elevation);
