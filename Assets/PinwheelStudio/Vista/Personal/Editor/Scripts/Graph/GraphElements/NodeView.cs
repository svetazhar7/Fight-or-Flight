    ...
    public class NodeView : Node
    {
        ...
        public static NodeView Create(INode node, IEdgeConnectorListener edgeConnectorListener)
        {
            ...
            if (meta != null)
            {
                ...
                {
                    nv.docLink = Links.GetDefaultNodeDocumentationUrl(nodeType);
                }
            }            
            ...
            if (outputSlot.Length == 0 || node is InstanceOutputNodeBase)
            {
        ...
        private NodeViewColor GetColors(string category)
        {
            ...
            else if (category.Equals("Generators"))
            {
                main = new Color32(15, 80, 80, 255);
            }
