    ...
    public static class Utilities
    {
        ...
        public static Mesh QuadMesh
        {
            get
            {
                if (quadMesh == null)
                {
                    quadMesh = Utilities.GetPrimitiveMesh(PrimitiveType.Quad);
                }
                return quadMesh;
            }
        }
        ...
        private static Color[] DEBUG_COLORS =
        {
            Color.white, Color.yellow, Color.green, Color.cyan, Color.red, Color.magenta
        };

        public static Color GetDebugColor(int value)
        {
            return DEBUG_COLORS[value % DEBUG_COLORS.Length];
        }
    }
} 
#endif