...
{
    public class UnderwaterRendererBirp : PostProcessEffectRenderer<UnderwaterBirp>
    {
        public override void Render(PostProcessRenderContext context)
        {
            Shader shader = WaterFxControllerBirp.underwaterShader;
            ...
            if (settings.enableCaustic && settings.causticTexture.value != null)
            {
                ...
                sheet.properties.SetTexture(PMat.PP_NOISE_TEX, settings.noiseTexture.value);
