...
{
    [System.Serializable]
    [PostProcess(typeof(UnderwaterRendererBirp), PostProcessEvent.BeforeStack, "Poseidon/Underwater", false)]
    public sealed class UnderwaterBirp : PostProcessEffectSettings
    {
        [Header("Water Body")]
